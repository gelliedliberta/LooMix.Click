            ...
            <div class="data-table mb-4">
                ...
                <div class="p-3">
                    <div class="mb-3">
                        ...
                        <div class="form-text">
                            <span id="titleCounter"><?= strlen($news['title']) ?></span>/255 karakter
                        </div>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="summary" name="summary" rows="3" 
                                  placeholder="Haber özeti..." required minlength="20" maxlength="500"><?= escape($news['summary']) ?></textarea>
                        <div class="form-text">
                            <span id="summaryCounter"><?= strlen($news['summary']) ?></span>/500 karakter (min: 20)
                        </div>
                        <div class="invalid-feedback">
            ...
            <div class="data-table mb-4">
                ...
                <div class="p-3">
                    ...
                    <textarea class="form-control" id="content" name="content" 
                              style="min-height: 400px;" required><?= $news['content'] ?></textarea>
                    <div class="form-text">
                ...
                <div class="p-3">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea class="form-control" id="meta_description" name="meta_description" 
                                  rows="2" maxlength="160" placeholder="Arama motorları için açıklama"><?= escape($news['meta_description']) ?></textarea>
                        <div class="form-text">
                            <span id="metaDescCounter"><?= strlen($news['meta_description']) ?></span>/160 karakter (ideal: 150-160)
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="meta_keywords" name="meta_keywords" 
                               value="<?= escape($news['meta_keywords']) ?>"
        ...
        <div class="col-lg-4">
                ...
                <div class="p-3">
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="status" name="status" required>
                            <option value="draft" <?= $news['status'] === 'draft' ? 'selected' : '' ?>>Taslak</option>
                            <option value="published" <?= $news['status'] === 'published' ? 'selected' : '' ?>>Yayınla</option>
                            <option value="archived" <?= $news['status'] === 'archived' ? 'selected' : '' ?>>Arşiv</option>
                        </select>
                    </div>
            ...
            <div class="data-table mb-4">
                ...
                <div class="p-3">
                    ...
                    <input type="hidden" name="featured_image" id="featured_image" value="<?= escape($news['featured_image']) ?>">
                    
                    <div id="imagePreview" class="text-center" <?= !empty($news['featured_image']) ? 'style="display: block;"' : 'style="display: none;"' ?>>
                        <?php if (!empty($news['featured_image'])): ?>
                            <img id="previewImg" src="<?= $news['featured_image'] ?>" alt="Preview" class="img-fluid rounded mb-2" style="max-height: 200px;">
                            <div>
...
<!-- Include TinyMCE (Anahtar gerektirmeyen public CDN build) -->
<script src="https://cdn.jsdelivr.net/npm/tinymce@6.8.3/tinymce.min.js" referrerpolicy="origin"></script>

<script>
let selectedTags = <?= json_encode(array_column($newsTags, 'name')) ?>;
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.getElementById('title').addEventListener('input', function() {
        ...
        const originalSlug = '<?= escape($news['slug']) ?>';
...
function saveNews() {
    ...
    .then(data => {
        if (data && data.success) {
            showNotification('Haber başarıyla güncellendi!', 'success');
            setTimeout(() => {
                window.location.href = '<?= url('/admin/haberler') ?>';
            }, 1500);
        } else {
            throw new Error((data && (data.message || data.error)) || 'Güncelleme hatası');
        }
    })
    .catch(error => {
        showNotification('Haber güncellenirken hata oluştu: ' + error.message, 'error');
    })
    .finally(() => {
